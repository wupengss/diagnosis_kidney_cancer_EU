...
from model.roi_layers import ROIAlign, ROIPool, ROIPool_3d
...
class _fasterRCNN(nn.Module):
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes):
        ...
        if self.training:
            # classification loss
            RCNN_loss_cls = F.cross_entropy(cls_score.cpu(), rois_label)
    ...
    def create_architecture(self,net):
...
class _fasterRCNN3d(nn.Module):
    ...
    def __init__(self, classes, class_agnostic):
        ...
        self.RCNN_roi_pool = ROIPool_3d((cfg.POOLING_SIZE, cfg.POOLING_SIZE, cfg.POOLING_SIZE), 1.0/16.0)
        self.RCNN_roi_align = ROIAlign((cfg.POOLING_SIZE, cfg.POOLING_SIZE), 1.0/16.0, 0)
